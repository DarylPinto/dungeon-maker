...
dungeon.data = new Object();
	...
	dungeon.data.biomes = {
		...
		advanced: [
			...
			new Biome('Angelic',    '#FFE791'),
			new Biome('Eldritch',   '#73A56A'),
			new Biome('Chaotic',    '#310526'),
			...
			new Biome('Gilded',     '#FFCEB6'),
			new Biome('Draconic',   '#BFAEE8'),
			new Biome('Fairy',      '#C7E8AE'),
			new Biome('Urban',      '#7A87B7'),
			new Biome('Copyright',  '#2F2F2F')
		]
	}